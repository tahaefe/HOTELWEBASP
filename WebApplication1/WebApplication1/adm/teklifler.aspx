<%@ Page Title="" Language="C#" MasterPageFile="~/adm/Admin1.Master" AutoEventWireup="true" CodeBehind="teklifler.aspx.cs" Inherits="WebApplication1.adm.teklifler1" %>
                    ...
                    <table class="auto-style1">
                        <tr>
                            <td class="auto-style4">
                                <asp:Literal ID="Literal1" runat="server" Text='<%# Eval("teklifBaslik") %>'></asp:Literal>
                            </td>
                            <td class="auto-style5">
                                <a href="tekliflerguncelle.aspx?teklifID=<%#Eval("teklifID") %>"><img alt="" class="auto-style6" src="../img/düzenle.png" /></a>
                            </td>
                            <td>
                                <a href='teklifler.aspx?teklifID=<%#Eval("teklifID") %>&amp;islem=sil'><img alt="" class="auto-style7" src="../img/sil.png" /></a>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
