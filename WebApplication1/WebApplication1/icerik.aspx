<%@ Page Title="" Language="C#" MasterPageFile="~/anasablon.Master" AutoEventWireup="true" CodeBehind="icerik.aspx.cs" Inherits="WebApplication1.icerik" %>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                <h3>Istanbul Holiday Hotel</h3>
                                <p>Discover Ayasofya and Istanbul with us</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                ...
                                <p>Unlock to enjoy the view of Istanbul Holiday</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                <h3>Life is Beautiful</h3>
                                <p>Unlock to history the view of Istanbul Holiday Hotel</p>
                            </div>
                        </div>
                    </div>
                </div>
