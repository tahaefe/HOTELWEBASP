<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rooms.aspx.cs" Inherits="WebApplication1.rooms" %>
 ...
 <!-- features_room_startt -->
    ...
    <div class="offers_area padding_top">
        <div class="container">
            ...
            <div class="row">
                <asp:Repeater ID="rptTeklif" runat="server" DataSourceID="dsTeklif">
                     <ItemTemplate>
                <div class="col-xl-4 col-md-4">
                    
                    <div class="single_offers">
                        <div class="about_thumb">
                            <img src="<%# Eval("teklifResim") %>" alt="">
                        </div>
                        <h3><%# Eval("teklifBaslik") %></h3>
                        <ul>
                            <li><%# Eval("teklifListe") %></li>
        ...
        $('#datepicker2').datepicker({
            ...
            icons: {
             rightIcon: '<span class="fa fa-caret-down"></span>'
                    ...
                    <asp:SqlDataSource ID="dsTeklif" runat="server" ConnectionString="<%$ ConnectionStrings:webDBConnectionString %>" SelectCommand="SELECT [teklifBaslik], [teklifListe], [teklifResim] FROM [Teklifler]"></asp:SqlDataSource>
